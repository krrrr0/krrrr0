...
| 세븐위키 | Developer-Friendly wiki service built w/ Modern Frameworks. | 2020- | WIP | [***dazzle.***](https://github.com/dazzleofficial) | [[Website]](https://seven.wiki) <br>Repo 비공개(보안) |
| 하나봇 | 하나인들을 위한 (간단) 카카오톡 챗봇 | 2021- | Active Service | 개인작 | 비공개/공개 예정 없음 |
| 도레미 디스코드 챗봇 | NLP를 곁들인 다목적 디스코드 챗봇, built w/ [Hikari](https://github.com/hikari-py/hikari) Framework | 2021- | On Private Beta | 개인작 | TODO |
| 나무위키 미러 | 나무위키 읽기전용 미러 서비스 | 2021- | Active Service | 개인작 | Undisclosed for Legal Reasons |
| PARTY | The New Social: 한국형 카카오톡 대체 메신저 | 2022- | WIP | 개인작 | Repo 비공개(개발중) |
|  | ***Work in Progress*** |   |  | |
