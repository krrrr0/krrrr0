...
- **Founder of Dazzle Inc. [\[Website\]](https://dazzle.works) [\[Github\]](https://github.com/dazzleofficial)**
  + 🥞 I mostly do backend stuff, but sometimes I also do frontend. Check out [dazzle.works](https://dazzle.works/).
  + 🍰 **Working On**: Developing backend engine for [seven.wiki](https://seven.wiki/). Dev-friendly tech wiki with nice apis.
...
- Personal Projects
  ...
  + 🍭 Another cool project: Virtual friend made with `LUIS`. She can talk and play some games with you!
