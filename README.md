...
- 📐 디자인에 관심이 많습니다. 간결함 속에서의 직관을 추구합니다.
####
...
| 이름      | 설명          | 연도         | 상태          | 개발   | 링크  |
|:----------|:--------------|:-------------|:--------------|:------:|:------|
| **급식봇5**  | NLP를 이용해 비정형 대화에서 급식을 가져오는 인공지능 페메 챗봇 | 2018- | ✅ | 개인작 | [[Repo]](https://github.com/dazzleofficial/mealworm5) [[메신저]](https://m.me/mealworm05) |
| **ASKY** | NLP를 이용한 인공지능 Companion<br>(HYU Gifted 수료작, 백엔드 개발.) | 2019 | ⏹️ | 팀플 w/ [@cliid](https://github.com/cliid), and 2 more | _업로드 예정_ |
| **세븐위키** | Developer-Friendly wiki service built w/ Modern Frameworks. | 2020- | 🏗️ | [***Dazzle.***](https://github.com/dazzleofficial) | [[링크]](https://seven.wiki) <br>Repo 비공개 <sub>(보안)</sub> |
...
| **나무위키 미러** <sub>(가칭)</sub> | 나무위키 읽기전용 미러 서비스 | 2021- | ✅ | 개인작 | 비공개 <sub>(For Legal Reasons)</sub> |
...
| **하나위키** | 하나고의 학술적 위키 사이트인 하나위키의 기술과 운영을 맡고 있습니다. | 2022- | 🏗️ | 교내 팀플 | [[링크]](https://hanawiki.org) |
...
💬 If you want to ask me about something, or just want to say hi, always feel free to reach me via email/DM/etc.
